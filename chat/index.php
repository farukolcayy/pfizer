...
<head>
    ...
    <title>Pfizer Soru Paneli</title>
...
<body>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                $query = $conn->query("SELECT * FROM questions ORDER BY `questions`.`dateTime` DESC", PDO::FETCH_ASSOC);
    ...
    <script src="./js/excelExport.js?v=1.4"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#exportButton1").click(function() {
                const header = ["Id", "Ad-Soyad", "E-mail", "Soru", "Tarih"];
                const worksheet = "Sorular";
                const filename = "Pfizer ile Medikalde Kariyer Sorular";
